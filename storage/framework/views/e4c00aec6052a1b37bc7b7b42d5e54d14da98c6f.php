      ...
      <main class="grid w-full grow grid-cols-1 place-items-center">
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
          <div class="text-center">
            ...
            <form method="POST"
                  action="<?php echo e($role == 2 ? route('customer-login') : $role == route('admin-login')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/vagrant/web/platinum-club-app/Platinum-Club-App/resources/views/auth/login.blade.php ENDPATH**/ ?>