    ...
    <div class="mt-3 flex items-center justify-between px-4 sm:px-5">
      ...
      <div class="flex items-center space-x-4">
        ...
        <select
          ...
          class="form-select h-8 rounded-full border border-slate-300 bg-white px-2.5 pr-9 text-xs+ hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent"
        >
          <option value="0" <?php if(request('duration',0)==0): echo 'selected'; endif; ?>>All Time</option>
          <option value="1" <?php if(request('duration',0)==1): echo 'selected'; endif; ?>>Last year</option>
          <option value="2" <?php if(request('duration',0)==2): echo 'selected'; endif; ?>>Last Month</option>
        </select>
        </form>
      </div>
    </div>
        ...
        <div class="mt-6 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 gap-y-8">
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($stat->revenue_earned,2)); ?></p>
            </div>
            <div
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($stat->ad_spends,2)); ?></p>
            </div>
            <div
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($stat->overheads,2)); ?></p>
            </div>
            <div
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($stat->net_profit,2)); ?></p>
            </div>
            <div
              class="mask is-diamond absolute top-0 right-0 -m-3 h-16 w-16 bg-white/20"
            ></div>
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($stat->leads_generated)); ?></p>
            </div>
            <div
              class="mask is-diamond absolute top-0 right-0 -m-3 h-16 w-16 bg-white/20"
            ></div>
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> <?php echo e(number_format($stat->cost_per_lead,2)); ?></p>
            </div>
            <div
              class="mask is-hexagon-2 absolute top-0 right-0 -m-3 h-16 w-16 bg-white/20"
            ></div>
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><?php echo e(number_format($stat->paid_customer)); ?></p>
            </div>
            <div
              class="mask is-reuleaux-triangle absolute top-0 right-0 -m-3 h-16 w-16 bg-white/20"
            ></div>
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><?php echo e(number_format($stat->total_customer)); ?></p>
            </div>
            <div
              class="mask is-hexagon-2 absolute top-0 right-0 -m-3 h-16 w-16 bg-white/20"
            ></div>
          ...
          >
            ...
            <div class="flex items-end justify-between space-x-2">
              <p class="mt-4 text-2xl font-medium text-white"><?php echo e(number_format($stat->profitability,2)); ?> %</p>
            </div>
            <div
              class="mask is-reuleaux-triangle absolute top-0 right-0 -m-3 h-16 w-16 bg-white/20"
            ></div>
