    ...
    <main class="container mx-auto mt-5">
        <div>
            ...
            <div class="grid grid-cols-2 gap-6 mt-7">
                    ...
                    <div class="mt-7">
                        <div class="grid grid-cols-3 gap-4 mt-4">
                            <div class="border border-b-slate-200 rounded-md  flex justify-center">
                                <img src="<?php echo e(asset('images/payment/stripe_logo.png')); ?>" alt="">
                            </div>
                            <div class="border border-b-slate-200 rounded-md  flex justify-center items-center">
                                <img src="<?php echo e(asset('images/payment/razorpay_logo.png')); ?>" alt=""
                                     style="width: 70%;height: 40px"/>
                            </div>
                            <div class="border border-b-slate-200 rounded-md  flex justify-center items-center">
                                <img src="<?php echo e(asset('images/payment/instamojo.png')); ?>" alt=""
                                     style="width: 70%;height: 40px"/>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div>
                        <img src="<?php echo e(asset('images/payment/marketing-online.png')); ?>" alt="" style="width: 100%;"/>
                        <div class="mt-3">
                            <p class="text-black">
