                        ...
                        <div class="card mt-3">
                            ...
                            >
                                <table class="is-hoverable w-full text-left">
                                    ...
                                    <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$single_expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"><?php echo e(((request('page',1)-1)*10+$loop->iteration)); ?></td>
                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"> <?php echo e($single_expense->expense); ?> </td>
                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5" > <?php echo e($single_expense->date ? ($single_expense->date?->format('d-m-Y')) : ''); ?> </td>
                                                    ...
                                                    >
                                                        <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                                                            <ul>
                                                                <li>
                                                                    <a
                                                                        href="<?php echo e(route('expenses.edit', $single_expense->id)); ?>"
                                                                        class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">
                                                                        Edit
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <form
                                                                        class="d-inline"
                                                                        action="<?php echo e(route('expenses.destroy',$single_expense->id)); ?>"
                                                                        method="POST">
                                                                        <?php echo csrf_field(); ?>
                                                                        <input name="_method" type="hidden" value="DELETE">
                                                                        <button class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Delete</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/web/platinum-club-app/Platinum-Club-App/resources/views/customer/incomes/index.blade.php ENDPATH**/ ?>