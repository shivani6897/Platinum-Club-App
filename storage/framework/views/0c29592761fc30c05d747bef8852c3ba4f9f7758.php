           	...
           	<ul class="mt-6 space-y-1.5 font-inter font-medium">
            	<li>
                  	...
                  	>
                    	...
                    	<span><?php echo e(Auth::user()->created_at->format('jS F, Y')); ?></span>
                  	</a>
                </li>
                <li>
                  	<a
	...
	<div class="col-span-12 lg:col-span-8">
        <div class="card">
          	...
          	<form method="POST" action="<?php echo e(route('updateProfile')); ?>" enctype="multipart/form-data">
          		<?php echo csrf_field(); ?>
          		<input type="hidden" name="user_id" value="<?php echo e($user ? $user->id : ''); ?>">
                	...
                	<div class="avatar mt-5 h-20 w-20">
                  	...
                  	>
              	  	 <div id="profilepicdiv">
              	  	 	<img src="<?php echo e(asset($user->profile?'/images/users/'.$user->profile:'images/200x200.png')); ?>">
              	  	 </div>
	                		...
	                		<span class="relative mt-1.5 flex">
	                  			<input
	                    			...
	                    			placeholder="First Name"
				                  	...
				                  	id="first_name"
				                  	name="first_name"
				                  	value="<?php echo e($user ? $user->first_name : ''); ?>"
				                  	required
	                			...
	                			<span class="relative mt-1.5 flex">
	                      			<input
	                        			...
	                        			placeholder="Last Name"
					                  	...
					                  	id="last_name"
					                  	name="last_name"
					                  	value="<?php echo e($user ? $user->last_name : ''); ?>"
	                		...
	                		<span class="relative mt-1.5 flex">
			                	...
			                	>
	                  			...
	                  			<input
				                  	...
				                  	id="phone_no"
				                  	name="phone_no"
				                  	value="<?php echo e($user ? $user->phone_no : ''); ?>"
				                  	required
	                		...
	                		<span class="relative mt-1.5 flex">
	                  			<input
	                    			...
	                    			placeholder="City"
				                  	...
				                  	id="city"
				                  	name="city"
				                  	value="<?php echo e($user ? $user->city : ''); ?>"
				                  	required
				                  	autocomplete="city"
				                  	autofocus
	              				/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/web/platinum-club-app/Platinum-Club-App/resources/views/user/profile.blade.php ENDPATH**/ ?>