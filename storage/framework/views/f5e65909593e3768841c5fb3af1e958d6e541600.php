<div class="main-sidebar">
  ...
  >
    ...
    <div class="flex pt-4">
      <a href="/">
        <img
          ...
          src="<?php echo e(asset('images/app-logo.svg')); ?>"
          alt="logo"
        />
      </a>
    </div>
    ...
    >
      ...
      <!-- Habits -->
        <a
            href="<?php echo e(route('habits.index')); ?>"
            class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
      ...
      >
        ...
        <!-- Business Stats -->
        <a
          href="<?php echo e(url('business-stats')); ?>"
          class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
...
<?php /**PATH /home/vagrant/web/platinum-club-app/Platinum-Club-App/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>