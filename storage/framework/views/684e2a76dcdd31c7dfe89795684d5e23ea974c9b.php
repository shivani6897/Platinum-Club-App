      ...
      <main class="grid w-full grow grid-cols-1 place-items-center">
        <div class="w-full max-w-[26rem] p-4 sm:px-5">
          <div class="text-center">
            ...
            <?php endif; ?>
          <form method="POST" action="<?php echo e(route('customer.password.set',$token)); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/vagrant/web/platinum-club-app/Platinum-Club-App/resources/views/customer/password_set.blade.php ENDPATH**/ ?>