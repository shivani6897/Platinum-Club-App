                    ...
                    <div class="justify-content-between dataTables_wrapper form-inline dt-bootstrap no-footer">
                        ...
                        <div>
                            ...
                            <div class="card mt-3">
                                    ...
                                    <table class="is-hoverable w-full text-left">
                                        ...
                                        @forelse($event as $key=>$single_event)
                                             <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                                ...
                                                <td class="whitespace-nowrap px-4 py-3 sm:px-5" > {{ $single_event->event_date_time }} </td>
                                ...
                                <div class="flex flex-col justify-end space-y-4 px-4 py-4 sm:flex-row sm:items-center sm:space-y-0 sm:px-5">
                                    <ol class="pagination">
