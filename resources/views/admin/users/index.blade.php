    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex">
        ...
        <div
          class="inline-flex"
        >
        <a href="{{route('admin.users.create')}}" class="btn space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">Add User</a>
        </div>
      </div>
    </div>
    <div class="card mt-3">
          ...
          <thead>
            ...
            @forelse($user as $users)
              ...
              >
                ...
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">{{ $users->club?->name }}
                </td>
                <td
